...
/**
 * 替换老版本的sightDetails类的功能，提供及解析并获得解析目标景点页面内容的接口
 */
public class SightPaser {
	...
	public String getSightName() {
		...
		try {
			...
			if (sightName == null || sightName.equals("")) {
				sightName = "空";
			}
	...
	public String getSightScore() {
		...
		try {
			...
			if (sightScore == null || sightScore.equals("")) {
				sightScore = "空";
			}
	...
	public String getsightIntroduction() {
		...
		try {
			...
			if (sightIntroduction == null || sightIntroduction.equals("")) {
				sightIntroduction = "空";
			}
